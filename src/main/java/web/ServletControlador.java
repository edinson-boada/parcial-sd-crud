...
public class ServletControlador extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (accion != null) {          
            switch (accion) {
                ...
                case "obtenerDetalle":  
                    System.out.println("Entre a obetener detalle xxxx");
    ...
    private void obtenerDetalle(HttpServletRequest request, HttpServletResponse response)
        ...
        String jspDetalle = "/WEB-INF/pages/alumno/detalleAlumno.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (accion != null) {
            ...
            System.out.println("Entre a obetener detalleaaaaaaaaaa");
            switch (accion) {
                case "insertarAlumno":
